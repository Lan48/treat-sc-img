...
if __name__ == '__main__':
    ...
    config = {
        ...
        'model_path': 'project1/model_outputs/maskdual_valid512(16)_sp_reg/checkpoint.pth',
        'emb_name': 'X_emb512_model40_16_sp_reg_v2',
        'mode': 'spatial', # 模式选择 spatial or single or padding
        'pad_size': 1.0
    }
    gene_selection_method = 'weighted_random' #"hvg": 使用高变基因"weighted_random": 加权随机选择）"uniform_random": 直接均匀随机选择
